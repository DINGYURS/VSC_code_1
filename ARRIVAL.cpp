...
int main()
{
    node* head1 = Create();
    node* head2 = Create();
    node* head = Plus(head1->next, head2->next);
    Print(head);
    return 0;
}
*/
...
*/
/*
#include<iostream>// https://pintia.cn/problem-sets/1706671731533787136/exam/problems/1706672016993923075?type=7&page=0
using namespace std;
int a[100001];
int main()
{
